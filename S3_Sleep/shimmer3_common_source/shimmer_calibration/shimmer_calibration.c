...
void ShimCalib_init(void)
{
    ...
    ShimCalib_default(SC_SENSOR_LSM303DLHC_ACCEL);
    ShimCalib_default(SC_SENSOR_LSM303DLHC_MAG);
}
...
uint8_t ShimCalib_ramWrite(const uint8_t* buf, uint8_t length,
                              uint16_t offset)
{
