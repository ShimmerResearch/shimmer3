...
def does_response_include_length_byte(get_cmd):
    return (get_cmd == shimmer_comms_bluetooth.BtCmds.GET_DAUGHTER_CARD_ID_COMMAND
            ...
            or get_cmd == shimmer_comms_bluetooth.BtCmds.GET_INFOMEM_COMMAND
...
class TestShimmerBluetoothCommunication(unittest.TestCase):
    ...
    def bt_cmd_test_set_common(self, set_cmd, set_bytes, get_cmd, response_cmd):
        ...
        if get_cmd_byte == shimmer_comms_bluetooth.BtCmds.GET_RWC_COMMAND:
            ...
            if ts_s_read - ts_s_written > 0.5:
                self.assertTrue(False, "RWC time out of range")
        else:
            for i in range(0, len(set_bytes) - comparison_offset):
                # FIXME something is overwriting byte index 96 infomem D from 256 to 8
                if (get_cmd_byte == shimmer_comms_bluetooth.BtCmds.GET_INFOMEM_COMMAND
                        and get_cmd[2] == 0x00
                        and get_cmd[3] == 0x00
                        and i == 96):
                    print("Skipping infomem D byte index 96 comparison")
    ...
    def test_04_get_shimmer_new_version_command_response(self):
    ...
    def test_08_get_gsr_range_command(self):
    ...
    def test_45_get_infomem_command(self):
        ...
        print("Infomem D:")
        response = self.bt_cmd_test_get_common([shimmer_comms_bluetooth.BtCmds.GET_INFOMEM_COMMAND, 0x80, 0x00, 0x00],
                                               shimmer_comms_bluetooth.BtCmds.INFOMEM_RESPONSE, 1)
        print("Infomem C:")
        response = self.bt_cmd_test_get_common([shimmer_comms_bluetooth.BtCmds.GET_INFOMEM_COMMAND, 0x80, 0x80, 0x00],
                                               shimmer_comms_bluetooth.BtCmds.INFOMEM_RESPONSE, 1)
        print("Infomem B:")
        response = self.bt_cmd_test_get_common([shimmer_comms_bluetooth.BtCmds.GET_INFOMEM_COMMAND, 0x80, 0x00, 0x01],
                                               shimmer_comms_bluetooth.BtCmds.INFOMEM_RESPONSE, 1)
        print("Infomem A:")
        response = self.bt_cmd_test_get_common([shimmer_comms_bluetooth.BtCmds.GET_INFOMEM_COMMAND, 0x80, 0x80, 0x01],
                                               shimmer_comms_bluetooth.BtCmds.INFOMEM_RESPONSE, 1)
    ...
    def test_51_set_config_bytes_command(self):
    ...
    def test_87_set_InfoMem_command(self):
        ...
        #  Config generated below from Consensys in-which the sensors

        print("Infomem D:")
        tx_bytes = []
        self.bt_cmd_test_set_common([shimmer_comms_bluetooth.BtCmds.SET_INFOMEM_COMMAND, 0x80, 0x00, 0x00], tx_bytes,
                                    [shimmer_comms_bluetooth.BtCmds.GET_INFOMEM_COMMAND, 0x80, 0x00, 0x00],
                                    shimmer_comms_bluetooth.BtCmds.INFOMEM_RESPONSE)
        print("Infomem C:")
        tx_bytes = []
        self.bt_cmd_test_set_common([shimmer_comms_bluetooth.BtCmds.SET_INFOMEM_COMMAND, 0x80, 0x80, 0x00], tx_bytes,
                                    [shimmer_comms_bluetooth.BtCmds.GET_INFOMEM_COMMAND, 0x80, 0x80, 0x00],
                                    shimmer_comms_bluetooth.BtCmds.INFOMEM_RESPONSE)
        print("Infomem B:")
        tx_bytes = []
        self.bt_cmd_test_set_common([shimmer_comms_bluetooth.BtCmds.SET_INFOMEM_COMMAND, 0x80, 0x00, 0x01], tx_bytes,
                                    [shimmer_comms_bluetooth.BtCmds.GET_INFOMEM_COMMAND, 0x80, 0x00, 0x01],
                                    shimmer_comms_bluetooth.BtCmds.INFOMEM_RESPONSE)
        print("Infomem A:")
        tx_bytes = []
        self.bt_cmd_test_set_common([shimmer_comms_bluetooth.BtCmds.SET_INFOMEM_COMMAND, 0x80, 0x80, 0x01], tx_bytes,
                                    [shimmer_comms_bluetooth.BtCmds.GET_INFOMEM_COMMAND, 0x80, 0x80, 0x01],
                                    shimmer_comms_bluetooth.BtCmds.INFOMEM_RESPONSE)
    ...
    def test_88_set_calib_dump_command(self):
        ...
        #                             shimmer_comms_bluetooth.BtCmds.RSP_CALIB_DUMP_COMMAND) # no calib dump response
