...
# read incoming data
   ...
   print "mac: ----------------------------------------" 
   inArg = [ord('m'),ord('a'),ord('c'),ord('$')]  
   sendUartOld(inArg) 
   print "ver: ----------------------------------------" 
   inArg = [ord('v'),ord('e'),ord('r'),ord('$')]  
   sendUartOld(inArg) 
   print "bat: ----------------------------------------" 
   inArg = [ord('b'),ord('a'),ord('t'),ord('$')]  
   sendUartOld(inArg) 
   print "rtc: ----------------------------------------" 
   inArg = [ord('r'),ord('t'),ord('c'),ord('$')]  
   #sendUartOld(inArg) 
   print "rct: ----------------------------------------" 
   inArg = [ord('r'),ord('c'),ord('t'),ord('$')]  
   sendUartOld(inArg) 
   print "rdt: ----------------------------------------" 
   inArg = [ord('r'),ord('d'),ord('t'),ord('$')]  
   sendUartOld(inArg) 
   print "tim: ----------------------------------------" 
   inArg = [ord('t'),ord('i'),ord('m'),ord('$')]  
   sendUartOld(inArg) 
