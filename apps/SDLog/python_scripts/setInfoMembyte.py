...
# read incoming data
   ...
   print "---------------------------------------- mac: " 
   sendUart([0x24, 0x03, 0x02, 0x01, UART_PROP_MAC]) 
   print "---------------------------------------- ver: " 
   sendUart([0x24, 0x03, 0x02, 0x01, UART_PROP_VER] )   
   print "---------------------------------------- bat: " 
   sendUart([0x24, 0x03, 0x02, 0x02, UART_PROP_VALUE]  )   
   print "---------------------------------------- info Mem Set: " 
   inArg = [0x24, 0x01, 0x07, 0x01, UART_PROP_INFOMEM, 0x02, 0xde, 0x18, 0x10,0x00]
   sendUart(inArg) 
   print "---------------------------------------- info Mem Set: " 
   ...
   #sendUart(inArg) 
   print "---------------------------------------- toggle info Mem flag: " 
   inArg = [0x24, 0x01, 0x06, 0x01, UART_PROP_INFOMEM, 0x01, 0xe6, 0x18, 0x01]
   sendUart(inArg) 
