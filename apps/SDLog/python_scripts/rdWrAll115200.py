...
# read incoming data
   ...
   inArg = [0x24, 0x01, 0x85, 0x01, UART_PROP_INFOMEM, 0x80, 0x00, 0x00, 
   ...
   0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0x99, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 
   0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x55, 0x44, 
   0x44, 0x44, 0x44, 0x44, 0x44, 0x44, 0x44, 0x44, 0x44, 0x44, 0x44, 0x44, 0x44, 0x44, 0x44, 0x44, 
   0x44, 0x44, 0x33, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff]  
   sendUart(inArg) 
   print "---------------------------------------- info Mem C Set: " 
   inArg = [0x24, 0x01, 0x85, 0x01, UART_PROP_INFOMEM, 0x80, 0x80, 0x00, 
   ...
   0x12, 0x34, 0x56, 0x78, 0x90, 0xab, 0x01, ord('a'), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
   0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff]
   sendUart(inArg) 
   print "---------------------------------------- info Mem B Set: " 
   inArg = [0x24, 0x01, 0x85, 0x01, UART_PROP_INFOMEM, 0x80, 0x00, 0x01, 
   0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88, 0x01, 0x23, 0x45, 0x67, 0x89, 0xab, 0xcd, 0xef, 
   ...
   inArg = [0x24, 0x03, 0x05, 0x01, UART_PROP_INFOMEM, 0x80, 0x00, 0x00] 
   sendUart(inArg) 
   print "---------------------------------------- info Mem C get: " 
   inArg = [0x24, 0x03, 0x05, 0x01, UART_PROP_INFOMEM, 0x80, 0x80, 0x00]
   sendUart(inArg) 
   print "---------------------------------------- info Mem B get: " 
   inArg = [0x24, 0x03, 0x05, 0x01, UART_PROP_INFOMEM, 0x80, 0x00, 0x01] 
   sendUart(inArg) 
